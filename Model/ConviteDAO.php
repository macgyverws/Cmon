<?php 
	class ConviteDAO{ //Classe de Acesso a Dados referentes ao Convite.
		...
		public function buscarConvites ($idConvidado){
			$buscar = mysql_query ("SELECT * FROM convite WHERE `idConvidado` = '$idConvidado'"); //Busca todos os convites de um usuário.
